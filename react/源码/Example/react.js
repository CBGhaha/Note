  ...
  return (function(e, t, n) {
  ...
  })(
    {
      1: [
        ...
        {
          './ReactCompositeComponent': 2,
          './ReactComponent': 3,
          './ReactDOM': 4,
          './ReactMount': 5,
          './ReactDefaultInjection': 6
        }
      ],
      2: [
        function(require, module, exports) {
          ;(function() {
            ...
            var ReactCompositeComponentMixin = {
              ...
              construct: function(initialProps, children) {
                ReactComponent.Mixin.construct.call(
                  this,
                  initialProps,
                  children
                )
              ...
              receiveProps: function(nextProps, transaction) {
                ...
                ReactComponent.Mixin.receiveProps.call(
                  this,
                  nextProps,
                  transaction
                )
              ...
              _renderValidatedComponent: function() {
                ...
                // console.log('ReactCurrentOwner:', this)
              ...
              _bindAutoBindMethod: function(method) {
                ...
                function autoBound(a, b, c, d, e, tooMany) {
                  ...
                  if (
                    component._lifeCycleState ===
                    ReactComponent.LifeCycle.MOUNTED
                  ) {
      ...
      3: [
          ...
          var ReactComponent = {
            ...
            Mixin: {
              ...
              mountComponentIntoNode: function(rootID, container) {
                console.log('mountComponentIntoNode', rootID)
                var transaction = ReactComponent.ReactReconcileTransaction.getPooled()
                transaction.perform(
              ...
              _mountComponentIntoNode: function(
                ...
                console.log('_mountComponentIntoNode:', rootID)
        ...
        },
        {
          ...
          './ReactCurrentOwner': 7,
          './ReactDOMIDOperations': 15,
          './ReactMount': 5,
          './ReactOwner': 8,
          './ReactReconcileTransaction': 16,
          './invariant': 10,
          './keyMirror': 11,
          './merge': 12
        }
      ...
      5: [
          ...
          ;(function() {
            ...
            var ReactMount = {
              ...
              findReactContainerForID: function(id) {
                var reatRootID = ReactInstanceHandles.getReactRootIDFromNodeID(
                  id
                )
        ...
        {
          './ReactEvent': 20,
          './ReactInstanceHandles': 21,
          './ReactEventTopLevelCallback': 22,
          './$': 23
        }
      ],
      6: [
      ...
      9: [
        ...
        { './emptyFunction': 29, './joinClasses': 30, './merge': 12 }
      ],
      11: [
        function(require, module, exports) {
          /**
      ...
      15: [
            ...
            var ReactDOMIDOperations = {
              ...
              updatePropertiesByID: function(id, properties) {
                for (var name in properties) {
                  ...
                  ReactDOMIDOperations.updatePropertiesByID(
                    id,
                    name,
                    properties[name]
                  )
              ...
              updateInnerHTMLByID: function(id, html) {
                ...
                node.innerHTML = ((html && html.__html) || '').replace(
                  /^ /g,
                  '&nbsp;'
                )
              },
              ...
              dangerouslyReplaceNodeWithMarkupByID: function(id, markup) {
                var node = ReactDOMNodeCache.getCachedNodeByIDgetCachedNodeByID(
                  id
                )
              ...
              setTextNodeValueAtIndexByParentID: function(
                parentID,
                index,
                value
              ) {
                var parent = ReactDOMNodeCache.getCachedNodeByID(parentID)
                DOMChildrenOperations.setTextNodeValueAtIndex(
                  parent,
                  index,
                  value
                )
        ...
        },
        {
          ...
          './DOMChildrenOperations': 33,
          './DOMPropertyOperations': 34,
          './ReactDOMNodeCache': 35,
          './getTextContentAccessor': 36,
          './invariant': 10
        }
      ],
      16: [
      ...
      17: [
        function(require, module, exports) {
          ...
          var DANGEROUSLY_SET_INNER_HTML = keyOf({
          ...
          ReactNativeComponent.Mixin = {
             ...
             */
            mountComponent: function(rootID, transaction) {
              console.log('ReactNativeComponent.mountComponent', rootID)
              ReactComponent.Mixin.mountComponent.call(
                this,
                rootID,
                transaction
              ...
              var a1 = this._createOpenTagMarkup()
              var a2 = this._createContentMarkup(transaction)
              var a3 = this._tagClose

              console.log(
                'ReactNativeComponent.mountComponent 结果：',
                a1 + a2 + a3
              )
              return a1 + a2 + a3
            },
            ...
            _updateDOMProperties: function(nextProps) {
              console.log(
                'native receiveProps=>_updateDOMProperties nextProps:',
                nextProps
              )
            ...
            _updateDOMChildren: function(nextProps, transaction) {
              ...
              var lastUsedContent = !thisPropsContentEmpty
                ? this.props.content
                : CONTENT_TYPES[typeof this.props.children]
                ? this.props.children
                : null

              var contentToUse = !nextPropsContentEmpty
                ? nextProps.content
                : CONTENT_TYPES[typeof nextProps.children]
                ? nextProps.children
                : null
              ...
              var childrenToUse =
                contentToUse != null ? null : nextProps.children

              if (contentToUse != null) {
                var childrenRemoved =
                  lastUsedChildren != null && childrenToUse == null
                if (childrenRemoved) {
                ...
                var contentRemoved =
                  lastUsedContent != null && contentToUse == null
                if (contentRemoved) {
                  ReactComponent.DOMIDOperations.updateTextContentByID(
                    this._rootNodeID,
                    ''
        ...
        function(require, module, exports) {
          ...
          function trapBubbledEvent(topLevelType, handlerBaseName, onWhat) {
            listen(
              onWhat,
              handlerBaseName,
              ReactEvent.TopLevelCallbackCreator.createTopLevelCallback(
                topLevelType
              )
            )
          }
      ...
      21: [
        function(require, module, exports) {
          ...
          function traverseParentPath(
            ...
            var ancestorID = ReactInstanceHandles.getFirstCommonAncestorID(
              start,
              stop
            )
            ...
            var traverse = traverseUp
              ? parentID
              : ReactInstanceHandles.nextDescendantID
            ...
            var ReactEventTopLevelCallback = {
              ...
              createTopLevelCallback: function(topLevelType) {
                return function(fixedNativeEvent) {
                  ...
                  var renderedTarget =
                    ReactInstanceHandles.getFirstReactDOM(
          ...
          ;(function() {
            ...
            var injection = {
              ...
              injectEventPluginsByName: function(pluginsByName) {
                injection.pluginsByName = merge(
                  injection.pluginsByName,
                  pluginsByName
                )
                injection._recomputePluginsList()
              },
              ...
              _recomputePluginsList: function() {
                ...
                if (injection.EventPluginOrder) {
                  // Else, do when plugin order injected
            ...
            function getPluginModuleForAbstractEvent(abstractEvent) {
              if (abstractEvent.type.registrationName) {
                ...
                for (var phase in abstractEvent.type.phasedRegistrationNames) {
                  if (
                    !abstractEvent.type.phasedRegistrationNames.hasOwnProperty(
                      phase
                    )
                  ) {
                    continue
            ...
            var extractAbstractEvents = function(
              ...
              for (var i = 0; i < len; i++) {
                ...
                if (extractedAbstractEvents) {
                  abstractEvents = accumulate(
                    abstractEvents,
                    extractedAbstractEvents
                  )
                }
              }
            ...
            var executeDispatchesAndRelease = function(abstractEvent) {
              if (abstractEvent) {
                var PluginModule = getPluginModuleForAbstractEvent(
                  abstractEvent
                )
                var pluginExecuteDispatch =
                  PluginModule && PluginModule.executeDispatch
            ...
            extractAbstractEvents: function(
              ...
              switch (topLevelType) {
                ...
                case topLevelTypes.topScroll:
                  data = AbstractEvent.normalizeScrollDataFromTarget(
                    renderedTarget
                  )
                  break
            ...
            setSelection: function(input, rangeObj) {
              ...
              if (document.selection) {
                ...
                if (input.tagName === 'TEXTAREA') {
                  var cr_before = (
                    input.value.slice(0, start).match(/\r/g) || []
                  ).length
                  var cr_inside = (
                    input.value.slice(start, end).match(/\r/g) || []
                  ).length
                  start -= cr_before
          ...
          copyProperties(emptyFunction, {
            ...
            mustImplement: function(module, property) {
              return function() {
                if (true) {
                  throw new Error(
                    module + '.' + property + ' must be implemented!'
                  )
                }
              }
            }
      ...
      32: [
        ...
        {
          './dangerousStyleValue': 59,
          './escapeTextForBrowser': 42,
          './hyphenate': 60,
          './memoizeStringOnly': 61
        }
      ],
      33: [
        function(require, module, exports) {
          ;(function() {
             ...
             * (potentially sparse.)
             */
            var _removeChildrenByOriginalIndex = function(
              parent,
             ...
             */
            var _placeNodesAtDestination = function(
              parent,
              childOperations,
              nodesByOriginalIndex
            ) {
            ...
            var manageChildren = function(parent, childOperations) {
              var nodesByOriginalIndex = _getNodesByOriginalIndex(
                parent,
                childOperations
              )
        ...
        { './Danger': 62, './insertNodeAt': 63, './keyOf': 44, './throwIf': 31 }
      ],
      34: [
        function(require, module, exports) {
          /**
            ...
            var ReactMultiChildMixin = {
              ...
              processChildDOMOperationsQueue: function() {
                if (this.domOperations) {
                  ReactComponent.DOMIDOperations.manageChildrenByParentID(
                    this._rootNodeID,
                    this.domOperations
                  )
              ...
              unmountMultiChild: function() {
                ...
                for (var name in renderedChildren) {
                  if (
                    renderedChildren.hasOwnProperty(name) &&
              ...
              updateMultiChild: function(nextChildren, transaction) {
                ...
                for (var name in nextChildren) {
                  ...
                  if (shouldManageExisting(curChild, nextChild)) {
                    ...
                    if (nextChild) {
                      // !shouldUpdate && nextChild => insert
                      this._renderedChildren[name] = nextChild
                      var nextMarkup = nextChild.mountComponent(
                        rootDomIdDot + name,
                        transaction
                      )
                      markupBuffer = markupBuffer
                        ? markupBuffer + nextMarkup
                        : nextMarkup
                      numPendingInsert++
      ...
      48: [
        function(require, module, exports) {
          ...
          function normalizeEvent(eventParam) {
            ...
            var eventTarget =
              normalized.target || normalized.srcElement || window
      ...
      52: [
        function(require, module, exports) {
          ...
          function accumulateDirectionalDispatches(
            ...
            if (listener) {
              abstractEvent._dispatchListeners = accumulate(
                abstractEvent._dispatchListeners,
                listener
              )
              abstractEvent._dispatchIDs = accumulate(
                abstractEvent._dispatchIDs,
                domID
              )
            }
          }
          ...
          function accumulateDispatches(id, ignoredDirection, abstractEvent) {
            if (abstractEvent && abstractEvent.type.registrationName) {
              var listener = getListener(
                id,
                abstractEvent.type.registrationName
              )
              if (listener) {
                abstractEvent._dispatchListeners = accumulate(
                  abstractEvent._dispatchListeners,
      ...
      55: [
        function(require, module, exports) {
          ...
          function eventDistance(coords, nativeEvent) {
            ...
            var pageY = AbstractEvent.eventPageY(nativeEvent)
            return Math.pow(
              Math.pow(pageX - coords.pageX, 2) +
                Math.pow(pageY - coords.pageY, 2),
              0.5
            )
          }
        ...
        { './EventConstants': 47, './AbstractEvent': 53, './invariant': 10 }
      ],
      56: [
        function(require, module, exports) {
          /**
        ...
        function(require, module, exports) {
          ...
          AbstractEvent.normalizePointerData = function(nativeEvent) {
            return {
              ...
              rightMouseButton: AbstractEvent.isNativeClickEventRightClick(
                nativeEvent
              )
            }
          }

          AbstractEvent.normalizeDragEventData = function(
            nativeEvent,
            globalX,
            globalY,
            startX,
      ...
      62: [
        ...
        { './ExecutionEnvironment': 14, './throwIf': 31 }
      ],
      64: [
        function(require, module, exports) {
          /**
      ...
      65: [
        function(require, module, exports) {
          ...
          mixInto(ReactTextComponent, {
            ...
            mountComponent: function(rootID) {
              ...
              console.log('other-mountComponent', rootID)
              return (
                '<span id="' +
                rootID +
                '">' +
        ...
        { './ReactComponent': 3, './escapeTextForBrowser': 42, './mixInto': 13 }
      ],
      68: [
        function(require, module, exports) {
          /**
